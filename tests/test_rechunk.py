...
@pytest.mark.parametrize("dims,target_chunks", [(None, (8000, 200)),
...
def test_rechunk_array(tmp_path, shape, source_chunks, dtype, dims, target_chunks, max_mem):
    ...
    delayed = api.rechunk(source_array, target_chunks, max_mem, target_store,
