...
from rechunker.types import ParallelPipelines, MultiStagePipeline, Stage
...
@pytest.mark.parametrize('Executor', [PythonPipelineExecutor, DaskPipelineExecutor, PrefectPipelineExecutor])
